    ...
    <div class="about-titlebox">
        ...
        <div class="about-titlebox__button">
            <div class="about-link-button">
                <button class="about-link-button__1">企業理念</button>
                <button class="about-link-button__2">代表メッセージ</button>
                <button class="about-link-button__3">会社概要</button>
            </div>
        </div>
    </div>
  </div>
...
<section class="Aabout-cnt">
  <div class="max-inner">
    <div class="Aabout-cnt__title">
        ...
        <div class="Aabout-cnt__title--sub">
          <span></span>
          <h3>VALUES</h3>
    ...
    <div class="Aabout-cnt__value">
      <div class="Aabout-cnt__value--card">
    ...
    <div class="Aabout-cnt__title Asecon Aright">
        <div class="Aabout-cnt__title--sub long-top">
          <span></span>
          <h3>VISION</h3>
          <p>企業・組織が目指す「あるべき姿」</p>
        </div>
...
<section class="Aabout-info">
  ...
  <div class="Aabout-info__content">
    <div class="Aabout-info__content--text">
